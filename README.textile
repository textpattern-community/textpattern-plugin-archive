...
*  `/plugins/xmp/xmp_example/1.0/README.textile` &ndash; Textile-formatted plugin information file
*  `/plugins/xmp/xmp_example/1.0/dist` &ndash; Ready-to-use encoded text
